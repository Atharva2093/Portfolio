            ...
            >
              <div className="grid lg:grid-cols-2 gap-8">
                {experiences.map((exp, index) => (
                  ...
                  >
                    <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 hover:border-purple-400/50 transition-all duration-300 h-full relative overflow-hidden">
                      {/* Gradient Overlay */}
                      ...
                      <div className="flex items-start justify-between mb-6 relative z-10">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-lg font-semibold mb-1" style={{ color: exp.color }}>
                              {exp.company}
                            </p>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className={`px-3 py-1 rounded-full text-xs font-medium border ${getImpactColor(exp.impact)}`}>
                            {exp.impact} Impact
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Meta Information */}
                      <div className="flex flex-wrap gap-4 text-sm text-gray-500 mb-6 relative z-10">
                        <div className="flex items-center gap-2">
                      ...
                      {/* Description */}
                      <p className="text-gray-400 leading-relaxed mb-6 relative z-10">{exp.description}</p>
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {exp.skills.map((skill, skillIndex) => (
                            <span
                              key={skillIndex}
                              className="bg-purple-500/20 text-purple-300 text-xs px-3 py-1 rounded-full border border-purple-400/30"
                            >
                              {skill}
                            </span>
                          ))}
            ...
            >
              <div className="relative">
                ...
                {experiences.map((exp, index) => (
                  ...
                  >
                    {/* Timeline Dot */}
                    <div className="absolute left-6 top-6 w-4 h-4 rounded-full border-4 border-white bg-purple-500 shadow-lg"></div>
                    
                    {/* Content Card */}
                    <div className="ml-16 bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 hover:border-purple-400/50 transition-all duration-300">
